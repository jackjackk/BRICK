...
option_list = list(
  ...
  make_option(c("-n", "--niter"), type="integer", default=2, help="number of iterations"),
...
amcmc.par1 = MCMC.parallel(log.post, niter.mcmc, p0.deoptim, n.chain=1, n.cpu=1,
#amcmc.par1 = MCMC(log.post, niter.mcmc, p0.deoptim,
                  ...
                  log.post(p0, parnames.in=parnames           , forcing.in=forcing         , l.project=l.project           , l.informed.prior.S=FALSE,
                  #slope.Ta2Tg.in=slope.Ta2Tg    , intercept.Ta2Tg.in=intercept.Ta2Tg,
                  ind.norm.data=ind.norm.data    , ind.norm.sl=ind.norm       , mod.time=mod.time             ,
